        ...
        >
            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div
                    ...
                    className="mt-24 rounded-3xl border border-zinc-800 bg-zinc-950 p-12 relative overflow-hidden"
                >

                    <img src="/media/transformation.jpg" alt="" className="absolute inset-0 h-full w-full object-cover" />
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-10 grid gap-4 md:grid-cols-2">
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Reinvention Strategy</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Digital Transition</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">AI Integration</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Scaling Systems</div>
                        </div>
                        <div className="mt-10">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-10 grid gap-4 md:grid-cols-2">
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Culture Transformation</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Mission Clarity</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Governance</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Organizational Alignment</div>
                        </div>
                        <div className="mt-10">
                            <h4 className="text-xl font-semibold text-white">
                                Expected Outcomes
                            ...
                            <ul className="mt-4 space-y-3 text-zinc-200">
                                ...
                                <li>• Healthier organizational cultures</li>
                                <li>• Improved team alignment</li>
                                <li>• Clearer strategic direction</li>
                            </ul>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-10 grid gap-4 md:grid-cols-2">
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Estate Planning</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Generosity Frameworks</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Kingdom Finance</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Legacy Planning</div>
                        </div>
                        <div className="mt-10">
                            <h4 className="text-xl font-semibold text-white">
                                Expected Outcomes
                            ...
                            <ul className="mt-4 space-y-3 text-zinc-200">
                                <li>• Greater financial clarity</li>
                                <li>• Purpose-driven wealth management</li>
                                <li>• Sustainable legacy planning</li>
                                <li>• Increased Kingdom impact</li>
                            </ul>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-10 grid gap-4 md:grid-cols-3">
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Social Impact Strategy</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Marketplace Ministry</div>
                            <div className="rounded-2xl border border-zinc-800 p-6 bg-zinc-900/70 backdrop-blur-xs">Community Transformation</div>
                        </div>
                        <div className="mt-10">
                            <h4 className="text-xl font-semibold text-white">
                                Expected Outcomes
                            ...
                            <ul className="mt-4 space-y-3 text-zinc-200">
                                ...
                                <li>• Purpose-driven organizational growth</li>
                                <li>• Increased Kingdom influence</li>
                            </ul>
                        </div>
                    </div>
